...
export default async function BlogPostPage({ params }: Props) {
  ...
  // Compile MDX on the server at request time — no Turbopack bundling involved
  const code = await compile(post.content, { outputFormat: 'function-body' })
  const { default: PostContent } = await run(code, {
