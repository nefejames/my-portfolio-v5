...
coverImage: "https://hdFQv9NqSbC5FLiN.public.blob.vercel-storage.com/portfolio/prismic/005-minimize-main-thread-work/cover.png"
tags: []
---
...
![With GTmetrix' speed visualization functionality, you can see a timeline with snapshots of the user interface with critical metrics mapped along the timeline. In this image, First Contentful Paint is mapped at 241 ms; Time to First Byte is mapped at 28ms; Largest Contentful Paint is mapped at 5.4s; Time to Interactive is mapped at 6.1s; and Onload time is mapped at 6.7s. Other tabs available include performance, structure, waterfall, and more (not pictured).](https://hdFQv9NqSbC5FLiN.public.blob.vercel-storage.com/portfolio/prismic/005-minimize-main-thread-work/image-1.png)
...
### How do you minimize main thread work in WordPress?

There are some quick ways you can try to minimize main thread work in WordPress, such as removing or replacing plugins that are adding unnecessary resources to your site during load time, using a lazy loading plugin, optimizing your site's images, and minifying, removing, or deferring JavaScript and CSS. However, if it's an option for your site, you can have a maximum impact on your Core Web Vitals by switching over to the Jamstack ecosystem and a headless content management product.
