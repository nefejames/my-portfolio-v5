...
coverImage: "https://hdFQv9NqSbC5FLiN.public.blob.vercel-storage.com/portfolio/prismic/008-headless-cms-seo/cover.png"
tags: []
---
...
![Headless CMS Architecture](https://hdFQv9NqSbC5FLiN.public.blob.vercel-storage.com/portfolio/prismic/008-headless-cms-seo/image-1.png)
...
![The Core Web Vitals components (source)](https://hdFQv9NqSbC5FLiN.public.blob.vercel-storage.com/portfolio/prismic/008-headless-cms-seo/image-2.png)
...
![Slow page load speed impact on bounce rate from SEMRush](https://hdFQv9NqSbC5FLiN.public.blob.vercel-storage.com/portfolio/prismic/008-headless-cms-seo/image-3.png)
...
|  | Headless SEO | Traditional SEO |
| --- | --- | --- |
|  | Allows for omnichannel content delivery since the frontend and the content are separate. | Does not support omnichannel delivery. It provides a limited number of channels for delivering content. |
|  | Gives freedom to work with preferred tools, integrations, and technologies. | Limited to the tools and integrations the platform offers. |
|  | Leads to fast page load times and enhanced performance. | Leads to slower page load times and poor performance. |
...
![URL Optmization for search from SEMRush](https://hdFQv9NqSbC5FLiN.public.blob.vercel-storage.com/portfolio/prismic/008-headless-cms-seo/image-4.png)
