...
<Figure
  src="/images/serp-analysis.png"
  alt="Screenshot of SERP results for a developer-focused keyword"
  caption="The SERP for 'react server components tutorial' shows tutorials dominate — not comparisons, not explainers."
/>
